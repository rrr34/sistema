...
<section>
	 <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-5">
						<h2><b>Listado de Puestos</b></h2>
					</div>
					<div class="col-sm-4"></div>
					
					<div class="col-sm-3">
						<div class="input-group">
						  <input class="form-control" id="buscadordepuestos">
				...
				<table class="table table-striped table-bordered table-sm"id="table_puestos_id" cellspacing="0" width="100%">
